...
def main():
    x_test_csv_path = ".../galaxy_test_data.csv"
    y_test_csv_path = ".../galaxy_test_label.csv"
    x_train_csv_path = ".../galaxy_train_data.csv"
    y_train_csv_path = ".../galaxy_train_label.csv"
    model_path = ".../galaxy_sp.keras"
    ...
    bulid(X_train, y_train, X_test, y_test, model_path, 32, 10)
